...
function injetarBotaoNeura() {
  ...
  style.textContent = `
    #neura-float-btn {
      ...
      animation: neuraPulse 3s ease-in-out infinite;
    ...
    #neura-float-btn img {
      ...
      filter:
        ...
        drop-shadow(0 0 14px rgba(168,85,247,0.45));
    }
  ...
  // LOGO
  btn.innerHTML = `
    <img src="assets/imgs/Neuralogo.png" alt="Neura IA Logo">
  `;
